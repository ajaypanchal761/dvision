      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-3 sm:pt-4 md:pt-5 lg:pt-6">
        ...
        <div className="pb-0">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
              <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-white">Manage Students</h1>
            </div>
            <button
          ...
          <div className="overflow-x-auto">
            {isLoading ? (
              <div className="p-6 sm:p-8 md:p-10 text-center">
                ...
                <p className="mt-2 sm:mt-3 text-gray-500 text-xs sm:text-sm">Loading students...</p>
              </div>
            ) : (
                    ...
                    <tr>
                      <td colSpan="9" className="px-3 sm:px-4 py-6 sm:py-8 text-center">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-gray-500 font-medium text-xs sm:text-sm">{searchTerm ? 'No students found matching your search.' : 'No students found.'}</p>
                          <p className="text-gray-400 text-[10px] sm:text-xs mt-1">{searchTerm ? 'Try adjusting your search criteria.' : 'Click "Add Student" to create one.'}</p>
                        </div>
                      </td>
                    </tr>
                  ) : (
                      ...
                      <tr key={student._id || student.id} className="hover:bg-gray-50 transition-all duration-200">
                        ...
                        <td className="px-2 sm:px-3 py-2 whitespace-nowrap text-center text-xs font-medium">
                          <div className="flex items-center justify-center space-x-1 sm:space-x-2">
                            ...
                            <button
                              onClick={() => handleDeleteClick(student._id || student.id)}
