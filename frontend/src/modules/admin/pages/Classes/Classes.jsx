...
const Classes = () => {
  ...
  const filteredClasses = classes.filter(classItem => {
    ...
    const classDisplay = classItem.type === 'preparation' 
      ? classItem.name 
      : `Class ${classItem.class}`
    const boardDisplay = classItem.type === 'preparation' 
      ? 'Preparation' 
      : classItem.board || ''
    
    return classDisplay.toLowerCase().includes(searchLower) ||
      boardDisplay.toLowerCase().includes(searchLower) ||
            ...
            <div className="bg-white rounded-lg shadow-md p-2.5 sm:p-3 md:p-4 border border-gray-200">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mt-0.5">{classes.length}</p>
                </div>
            ...
            <div className="bg-gray-50 rounded-lg shadow-md p-2.5 sm:p-3 md:p-4 border border-gray-100">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mt-0.5 sm:mt-1">{classes.filter(c => c.status === 'Active' || (c.isActive !== undefined && c.isActive)).length}</p>
                </div>
            ...
            <div className="bg-gray-50 rounded-lg shadow-md p-2.5 sm:p-3 md:p-4 border border-gray-100">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mt-0.5 sm:mt-1">{filteredClasses.length}</p>
                </div>
