...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('teachersUpdated', handleUpdate)
    window.addEventListener('classesUpdated', handleUpdate)
    window.addEventListener('subjectsUpdated', handleUpdate)
    window.addEventListener('coursesUpdated', handleUpdate)
    window.addEventListener('quizzesUpdated', handleUpdate)
    ...
    return () => {
      ...
      window.removeEventListener('teachersUpdated', handleUpdate)
      window.removeEventListener('classesUpdated', handleUpdate)
      window.removeEventListener('subjectsUpdated', handleUpdate)
      window.removeEventListener('coursesUpdated', handleUpdate)
      window.removeEventListener('quizzesUpdated', handleUpdate)
