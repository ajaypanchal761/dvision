      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-3 sm:pt-4 md:pt-5 lg:pt-6">
        ...
        <div className="pb-0">
          <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
            ...
            <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-[#1e3a5f]">Add New Subject</h1>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md border border-gray-200 p-3 sm:p-4 md:p-5 space-y-3 sm:space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="md:col-span-2">
                ...
                {allClasses.length === 0 && (
                  <p className="text-xs text-red-500 mt-1">No classes available. Please create a class first.</p>
                )}
              </div>
