...
/**
 * Live Classes Page
 * Shows scheduled live classes with search and date filtering
...
const LiveClasses = () => {
  ...
  const fetchLiveClasses = async () => {
    try {
      ...
      let dateParam = null;
      if (selectedDate) {
        // If selectedDate is already in YYYY-MM-DD format (from input type="date"), use it directly
  ...
  const resetDate = () => {
    console.log('[LiveClasses] Resetting to today');
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className="hidden sm:inline text-xs sm:text-sm font-medium">Timetable</span>
              </button>
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center min-h-[50vh] py-8">
            <div className="w-16 h-16 bg-[var(--app-dark-blue)]/10 rounded-full flex items-center justify-center mb-4">
              <FiVideo className="text-[var(--app-dark-blue)] text-3xl" />
            </div>
            <h2 className="text-lg sm:text-xl font-bold text-gray-800 mb-1.5 text-center">
              No Subscription
            </h2>
            <p className="text-gray-500 text-center max-w-md text-xs sm:text-sm px-4 mb-4">
              You need an active subscription to access live classes. Please subscribe to a plan to continue learning.
            </p>
            <button
          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            {(() => {
              const liveNow = liveClasses.filter(lc => lc.computedStatus === 'live');
              const startsSoon = liveClasses.filter(lc => lc.computedStatus === 'scheduled');
              const ended = liveClasses.filter(lc => lc.computedStatus === 'ended');
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-600">
                                  ...
                                  <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="font-medium text-green-600">Live Now</span>
                                  </div>
                                </div>
                              </div>
                              <button
